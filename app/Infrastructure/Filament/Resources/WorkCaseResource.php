...
//                    ->rows(10),
    ...
    {
        return [
            'index' => \App\Infrastructure\Filament\Resources\WorkCaseResource\Pages\ListWorkCases::route('/'),
            'create' => \App\Infrastructure\Filament\Resources\WorkCaseResource\Pages\CreateWorkCase::route('/create'),
            'edit' => \App\Infrastructure\Filament\Resources\WorkCaseResource\Pages\EditWorkCase::route('/{record}/edit'),
        ];
    }
}
